      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        {projectsData.map((p) => (
          <motion.button
            ...
            type="button"
            onClick={() => {
              trackEvent("project_card_open", { project: p.slug });
              setOpen(p);
            }}
              ...
              <footer className="sticky bottom-0 z-10 flex flex-wrap items-center gap-2 border-t border-border bg-card/95 px-5 py-3 backdrop-blur-md sm:px-7">
                {open.demoUrl && (
                  <Link
                    ...
                    onClick={() => trackEvent("project_demo_click", { project: open.slug })}
                  >
                ...
                {open.repoUrl && (
                  <Link
                    ...
                    onClick={() => trackEvent("project_repo_click", { project: open.slug })}
                  >
